...
function updateTimer() {
  const targetDate = new Date("June 4, 2025 18:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '543883346670'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  const recipientNumber1 = '543884549169'; 
  const recipientNumber2 = '543884644175'; 
  ...
  document.getElementById('botoncito2').addEventListener('click', function (event) {
    sendMessage(recipientNumber2, event);
  });
});
...
function cerrarPreloader(reproducirMusica) {
  ...
  document.body.classList.remove('loader-active'); // ✅ Mostrar scroll
